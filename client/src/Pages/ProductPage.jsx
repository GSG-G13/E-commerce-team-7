        ...
        <div className="cart-table">
          <div className="row cart-row">
            ...
            <div className="col-md-6 details">
              ...
              <div className="product-articlenr">Lorem ipsum dolor sit amet consectetur adipisicing elit. Alias, laboriosam.</div>
              <div className="product-options">
                <span>Price:</span>
                <span>30$</span>
              </div>
              <div className="qtySelector text-center">
                <i className="decreaseQty">_</i>
                <input type="text" className="qtyValue" />
                <i className="increaseQty">+</i>
              </div>
            </div>
            <div className="col-md-3 cart-actions">
              <div className="product-delete">
                <button type="button" data-toggle="tooltip" title="Ta bort" className="delete">X</button>
              </div>
            </div>
          </div>
        </div>
